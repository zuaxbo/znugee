...
namespace FileManagementAPI.Services
{
    public class FileService : IFileService
    {
        ...
        public ApiResponse<FileListModel> UploadFile(HttpPostedFile file, string customFileName, int userId, string username)
        {
            try
            {
                // 檢查檔案
        ...
        public ApiResponse BatchOperation(List<int> fileIds, string operation, int userId)
        {
            try
            {
                int successCount = 0;
